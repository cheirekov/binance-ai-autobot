...
|---|---|---|---|
| T-031 | IN_PROGRESS | Regime engine v2 | Current slice keeps daily-loss managed exits reachable through non-hard recovery/min-order cooldown locks after the May 7 bundle showed material `SOLUSDC`/`ZECUSDC` exposure boxed by caution fallback. |
