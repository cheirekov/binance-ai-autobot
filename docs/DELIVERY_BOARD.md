...
|---|---|---|---|
| T-031 | IN_PROGRESS | Regime engine v2 | Current slice preserves deterministic risk-budget defense and makes over-budget defensive mode reduce managed exposure before returning new-exposure skips. |
