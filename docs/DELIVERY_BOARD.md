...
| T-023 | TODO | Universe filter-chain architecture v1 | Improve autonomous pair discovery quality and explainability | Better candidate quality and less symbol-selection drift | Introduce generator+filters pipeline (liquidity/volatility/range/performance/price) with stage diagnostics and cache TTL. Pre-step delivered: wallet-driven quote hints + stale-cache auto-rescan. |
