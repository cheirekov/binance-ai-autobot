...
export const AdvancedSettingsSchema = z.object({
  ...
  routingBridgeAssets: z.array(z.string().min(1)).max(20).default(["USDT", "USDC", "BTC", "ETH", "BNB"]),
  universeQuoteAssets: z.array(z.string().min(1)).max(20).default([]),
  walletQuoteHintLimit: z.number().int().min(0).max(20).default(8),
